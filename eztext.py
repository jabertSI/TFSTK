    ...
    def update(self, events):
        ...
        for event in events:
            ...
            if event.type == KEYDOWN:
                ...
                if not self.shifted:
                    if event.key == K_a and 'q' in self.restricted: self.value += 'q'
                    ...
                    elif event.key == K_q and 'a' in self.restricted: self.value += 'a'
                    ...
                    elif event.key == K_w and 'z' in self.restricted: self.value += 'z'
                    elif event.key == K_x and 'x' in self.restricted: self.value += 'x'
                    elif event.key == K_y and 'y' in self.restricted: self.value += 'y'
                    elif event.key == K_z and 'w' in self.restricted: self.value += 'w'
                    ...
                    elif event.key == K_SEMICOLON and 'm' in self.restricted: self.value += 'm'
                    elif event.key == K_QUOTE and '\'' in self.restricted: self.value += '\''
                    elif event.key == K_COMMA and 'm' in self.restricted: self.value += 'm'
